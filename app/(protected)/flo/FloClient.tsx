            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100 transition-colors">LeadFlo</p>
                    <p className="text-[11px] text-zinc-600">Leads · Pipeline · Proposals</p>
                  </div>
                  <svg className="w-3.5 h-3.5 text-zinc-700 group-hover:text-zinc-500 ml-auto shrink-0 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100 transition-colors">Intakes</p>
                    <p className="text-[11px] text-zinc-600">Client intake submissions</p>
                  </div>
                  <svg className="w-3.5 h-3.5 text-zinc-700 group-hover:text-zinc-500 ml-auto shrink-0 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
